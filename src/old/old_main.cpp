...
#include "../algorithm/ac_tree.h"
#include "test_shared_ptr.h"
#include "test.h"
#include "../cnc/test_db_pp.h"
...
void test9() {
    ...
    std::cout << "******intersection: x = " << intersection.x << ", y = " << intersection.y << ", width = " << intersection.width << ", height = " << intersection.height
              << std::endl;
